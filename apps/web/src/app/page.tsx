...
export const metadata: Metadata = {
  ...
  description:
    "Calculate the perfect grind settings for your coffee grinder. Find the right grind size for Turkish, Espresso, Pour Over, French Press, and more.",
  keywords: [
    "coffee grinder",
    "grind size",
    "calculator",
  ...
  return (
    <main className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-8">
        Coffee Grinder Size Calculator
      </h1>
      <GrinderCalculator />
    </main>
  );
