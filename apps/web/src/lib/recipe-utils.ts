...
export const createCustomRecipe = (params: CustomRecipeParams): Recipe => {
  const {
    ...
    mode = "basic",
    inputMode = "coffee",
    totalBrewTimeSeconds = DEFAULT_BLOOM_TIME +
      pours * (DEFAULT_POUR_TIME + DEFAULT_INTERVAL_BETWEEN_POURS) +
      DEFAULT_DRAWDOWN_TIME,
    waterTemperature,
    temperatureUnit = "C",
  } = params;
  ...
  const totalBrewTime = lastStep
    ? lastStep.targetTimeInSeconds + DEFAULT_DRAWDOWN_TIME
    : DEFAULT_BLOOM_TIME +
      pours * (DEFAULT_POUR_TIME + DEFAULT_INTERVAL_BETWEEN_POURS) +
      DEFAULT_DRAWDOWN_TIME;
...
const createBasicModeSteps = ({
  ...
  const remainingTime =
    totalBrewTimeSeconds - bloomDuration - DEFAULT_DRAWDOWN_TIME;
  const remainingWater = waterWeight - bloomWater;
  ...
  const tempText = waterTemperature
    ? ` (${waterTemperature}°${temperatureUnit || "C"})`
    : "";
 ...
 */
export const calculateRecipeWithCustomWater = (
  recipe: Recipe,
    ...
    if (step.type === "pour") {
      ...
      return {
        ...
        instruction: step.instruction.replace(
          /reach \d+g/,
          `reach ${Math.round(runningTotal)}g`,
        ),
      };
    }
    return step;
    ...
    steps: [
      {
        ...
        instruction:
          "Pour 54g of water to bloom the coffee grounds and gently swirl",
      },
      {
        id: uuidv4(),
        type: "pour",
        ...
        instruction:
          "Pour slowly in circular motion until you reach 132g total",
      },
      {
        id: uuidv4(),
        type: "pour",
        ...
        targetRatio: 78 / 288, // ~27% of total water
        instruction:
          "Pour slowly in circular motion until you reach 210g total",
      },
      {
        id: uuidv4(),
        type: "pour",
        ...
        targetRatio: 78 / 288, // ~27% of total water
        instruction:
          "Pour slowly in circular motion until you reach 288g total",
      },
      {
        id: uuidv4(),
        type: "drawdown",
    ...
    steps: [
      {
        ...
        instruction:
          "Pour 90g of water to bloom and gently swirl to saturate all grounds",
      },
      {
        id: uuidv4(),
        type: "pour",
    ...
    steps: [
      {
        ...
        instruction:
          "Pour 55g of water and gently stir to ensure all grounds are saturated",
      },
      {
        id: uuidv4(),
        type: "pour",
        ...
        instruction:
          "Pour slowly in concentric circles until you reach 205g total",
      },
      {
        id: uuidv4(),
        type: "pour",
